...
def draw():
    ...
    if (game_over):
        canvas.create_text(WINDOW_WIDTH/2, WINDOW_HEIGHT/2, font = "Cascadia 20", text = f"Game Over: {score}", fill = "black")
    else:
        canvas.create_text(30, 20, font = "Cascadia 10", text = f"Score: {score}", fill = "black")
